...
test_inter_args && \
test_inter "padinton" "paqefwtdjetyiytjneytjoeyjnejeyj" "padinto" && \
test_inter "ddf6vewg64f" "gtwthgdwthdwfteewhrtag6h4ffdhsd" "df6ewg4" && \
test_inter "rien" "cette phrase ne cache rien" "rien" && \
test_inter "" "" "" && \
test_inter "abcdef" "ghiklmn" "" && \
test_inter "abcdef" "" "" && \
test_inter "" "yaya" ""
